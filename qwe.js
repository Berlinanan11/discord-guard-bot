...
const botroles = Exeal.botrolleri; // Botların Rolleri
...
client.user.setActivity("Exeal 💖 Maveria", { type: "PLAYING"}); //// TYPE - WATCHING , PLAYING , LISTENING
});
...
client.login(Exeal.token); // Glitchde kullanacaklar varsa process.env.token yazıp env e token girebilirler
